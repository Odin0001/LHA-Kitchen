...
const CreateRecipe = () => {
  ...
  return (
    <main className='max-w-xl mx-auto px-2 my-8'>
      <h1 className='text-4xl text-center mt-6 font-bold text-green-600 mt-6'>Create Recipe</h1>
      <div className='rounded-lg bg-green-500 p-4 mt-6'>
        ...
        <ul>
          ...
          <button type='button' onClick={submitForm} className='w-full py-2 mt-4 rounded text-white text-center bg-green-700 hover:bg-green-600 text-xl transition duration-500 ease'>Create Recipe</button>
        </ul>
      </div>
    </main>
  )
